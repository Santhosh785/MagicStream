...
type Ranking struct {
	...
	RankingName  string `bson:"ranking_value" json:"ranking_value" validate:"required"`
}
...
type Movie struct {
	...
	Genre       []Genre       `bson:"genre" json:"genre" validate:"required,dive"` //dive means Genre struct will also get validate
